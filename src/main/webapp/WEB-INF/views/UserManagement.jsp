            ...
            <form ng-submit="ctrl.submit()" name="myForm" class="form-horizontal">
                ...
                <div class="row">
                    <div class="form-group col-md-12">
                        ...
                        <div class="col-md-7">
                            <input type="text" ng-model="ctrl.user.lastname" id="lastname" class="lastname form-control input-sm" placeholder="Enter your lastname" required ng-minlength="3"/>
                            <div class="has-error" ng-show="myForm.$dirty">
                ...
                <div class="row">
                    <div class="form-group col-md-12">
                        ...
                        <div class="col-md-7">
                            <input type="text" ng-model="ctrl.user.telephone" id="telephone" class="telephone form-control input-sm" placeholder="Enter your telephone" required ng-minlength="3"/>
                            <div class="has-error" ng-show="myForm.$dirty">
                                <span ng-show="myForm.telephone.$error.required">This is a required field</span>
                                <span ng-show="myForm.telephone.$error.minlength">Minimum length required is 3</span>
                                <span ng-show="myForm.telephone.$invalid">This field is invalid </span>
                            </div>
                        </div>
                    </div>
                </div>
